...
offsets2 = euler_matrix(0.01, 0.03, 0.0,'rxyz') # Rudolph # was -0.015 pitch
offsets3 = euler_matrix(0.02, 0.00, 0.00,'rxyz') # Dasher with shell # was 0.015 roll, 0.005 pitch
